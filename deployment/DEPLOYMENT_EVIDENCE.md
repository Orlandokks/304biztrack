...
![Figure 3. Istanbul coverage report showing 95.45% line coverage.](evidence/coverage-report.png)

Caption: Figure 3. Istanbul coverage report generated by `npm run coverage`, showing 95.45% line coverage for the tested BizTrack utility and baseline modules.
...
Figure X. Istanbul coverage report showing 95.45% line coverage after running the Vitest test suite with Istanbul coverage.
